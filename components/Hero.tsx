...
export default function Hero({}: Props) {
  return (
    <div className='md:flex md:items-center md:justify-between w-full mt-4 mb-24'>
        ...
        <h1 className="text-5xl font-bold mb-3 text-white leading-none" style={{ textShadow: '2px 2px 8px rgba(0, 0, 0, 0.3)' }}>
          ...
          <p className="mb-6">
            ...
            enabling fans to earn Creator token rewards for watching their favorite Creator, directly on YouTube.
          </p>
