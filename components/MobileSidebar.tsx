  ...
  return (
    <div className="space-y-4 flex flex-col h-full text-primary bg-secondary">
      <div className="p-3 flex-1 flex flex-col justify-start items-center">
          <div className="rounded-md border h-28 w-28 text-xs group flex justify-start items-center font-medium cursor-pointer my-2 text-primary" onClick={() => router.push('/')}>
...
export const MobileSidebar = ({}: {}) => {
  return (
    <Sheet>
      ...
      <SheetContent side="left" className="p-0 bg-secondary pt-10 w-38">
        <Sidebar />
      </SheetContent>
    </Sheet>
  );
